...
class CustomVidioPlayer extends StatefulWidget {
  final Post post;

  const CustomVidioPlayer({
    Key? key,
    required this.post,
  }) : super(key: key);

  @override
  State<CustomVidioPlayer> createState() => _CustomVidioPlayerState();
}

class _CustomVidioPlayerState extends State<CustomVidioPlayer> {
